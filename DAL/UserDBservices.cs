...
public class UserDBservices
{
    ...
    //--------------------------------------------------------------------------------------------------
    public int InsertUser(string FullName, string ImageUrl, UserType userType, string Email, string Password, double AddressLatitude, double AddressLongtitude, long BirthDate)
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        cmd = CreateInsertUserWithStoredProcedure("SP_InsertUser", con, FullName, ImageUrl, userType, Email, Password, AddressLatitude, AddressLongtitude, BirthDate); // create the command
    ...
    //---------------------------------------------------------------------------------
    private SqlCommand CreateInsertUserWithStoredProcedure(String spName, SqlConnection con, string FullName, string ImageUrl, UserType userType, string Email, string Password, double AddressLatitude, double AddressLongtitude, long BirthDate)
    {
    ...
    public int UpdateUser(string fullName, string ImageUrl, UserType userType, string email, string password, double addressLatitude, double addressLongitude, long birthDate)
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        cmd = CreateUpdateUserWithStoredProcedure("SP_UpdatetUser", con, fullName, ImageUrl, userType, email, password, addressLatitude, addressLongitude, birthDate);
    ...
    //---------------------------------------------------------------------------------
    private SqlCommand CreateUpdateUserWithStoredProcedure(String spName, SqlConnection con, string fullName, string ImageUrl, UserType userType, string email, string password, double addressLatitude, double addressLongitude, long birthDate)
    {
